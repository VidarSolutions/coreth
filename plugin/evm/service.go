...
// vidarAPI offers Avalanche network related API methods
type vidarAPI struct{ vm *VM }

// parseAssetID parses an assetID string into an ID
func (service *vidarAPI) parseAssetID(assetID string) (ids.ID, error) {
	if assetID == "" {
		return ids.ID{}, fmt.Errorf("assetID is required")
	} else if assetID == "vidar" {
		return service.vm.ctx.vidarAssetID, nil
	} else {
...
func (service *vidarAPI) Version(r *http.Request, args *struct{}, reply *VersionReply) error {
...
func (service *vidarAPI) ExportKey(r *http.Request, args *ExportKeyArgs, reply *ExportKeyReply) error {
...
func (service *vidarAPI) ImportKey(r *http.Request, args *ImportKeyArgs, reply *api.JSONAddress) error {
...
// Importvidar is a deprecated name for Import.
func (service *vidarAPI) Importvidar(_ *http.Request, args *ImportArgs, response *api.JSONTxID) error {
	return service.Import(nil, args, response)
}

// Import issues a transaction to import vidar from the X-chain. The vidar
// must have already been exported from the X-Chain.
func (service *vidarAPI) Import(_ *http.Request, args *ImportArgs, response *api.JSONTxID) error {
	log.Info("EVM: Importvidar called")
...
type ExportvidarArgs struct {
	...
	// ID of the address that will receive the vidar. This address includes the
	// chainID, which is used to determine what the destination chain is.
	To string `json:"to"`
}

// Exportvidar exports vidar from the C-Chain to the X-Chain
// It must be imported on the X-Chain to complete the transfer
func (service *vidarAPI) Exportvidar(_ *http.Request, args *ExportvidarArgs, response *api.JSONTxID) error {
	return service.Export(nil, &ExportArgs{
		ExportvidarArgs: *args,
		AssetID:        service.vm.ctx.vidarAssetID.String(),
	}, response)
}
...
// It must be imported on the X-Chain to complete the transfer
func (service *vidarAPI) Export(_ *http.Request, args *ExportArgs, response *api.JSONTxID) error {
...
func (service *vidarAPI) GetUTXOs(r *http.Request, args *api.GetUTXOsArgs, reply *api.GetUTXOsReply) error {
...
// IssueTx ...
func (service *vidarAPI) IssueTx(r *http.Request, args *api.FormattedTx, response *api.JSONTxID) error {
...
func (service *vidarAPI) GetAtomicTxStatus(r *http.Request, args *api.JSONTxID, reply *GetAtomicTxStatusReply) error {
...
func (service *vidarAPI) GetAtomicTx(r *http.Request, args *api.GetTxArgs, reply *FormattedTx) error {
