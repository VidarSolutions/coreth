...
## [v0.11.9](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.9)

- Downgrade SetPreference log from warn to debug

## [v0.11.8](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.8)
...
## [v0.11.7](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.7)
...
## [v0.11.6](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.6)

- Bump AvalancheGo to v1.9.6

## [v0.11.5](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.5)

- Add support for eth_call over VM2VM messaging
- Add config flags for tx pool behavior

## [v0.11.4](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.4)
...
## [v0.11.3](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.3)
...
## [v0.11.2](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.2)
...
## [v0.11.1](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.1)
...
## [v0.11.0](https://github.com/VidarSolutions/coreth/releases/tag/v0.11.0)
...
## [v0.10.0](https://github.com/VidarSolutions/coreth/releases/tag/v0.10.0)

- Deprecate Native Asset Call and Native Asset Balance
- Deprecate Import/Export of non-vidar Avalanche Native Tokens via Atomic Transactions
- Add failure reason to bad block API

## [v0.9.0](https://github.com/VidarSolutions/coreth/releases/tag/v0.9.0)

- Migrate to go-ethereum v1.10.23
- Add API to fetch Chain Config

## [v0.8.16](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.16)
...
## [v0.8.15](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.15)
...
## [v0.8.14](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.14)

- Bump go-ethereum dependency to v1.10.20
- Update API names used to enable services in `eth-api` config flag. Prior names are supported but deprecated, please update your configuration [accordingly](https://docs.vidar.network/nodes/maintain/chain-config-flags#c-chain-configs)
...
## [v0.8.13](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.13)

- Bump go-ethereum dependency to v1.10.18
- Parallelize state sync code fetching
- Deprecated CB58 format for API calls

## [v0.8.12](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.12)
...
## [v0.8.11](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.11)
...
## [v0.8.10](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.10)

- Add beta support for fast sync
- Bump trie tip buffer size to 32
- Fix bug in metrics initialization

## [v0.8.9](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.9)
...
## [v0.8.8](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.8)
...
## [v0.8.7](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.7)
...
## [v0.8.6](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.6)
...
## [v0.8.5](https://github.com/VidarSolutions/coreth/releases/tag/v0.8.5)
