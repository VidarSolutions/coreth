...
go build -ldflags "-X github.com/VidarSolutions/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/VidarSolutions/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
